...
function MoveTo()
	...
	--local currentPos = float3(selfPlayer:getPositionX(), selfPlayer:getPositionY(), selfPlayer:getPositionZ())
	local targetPos = float3(46248.929688, -3044.798828, -48136.585938)
	local targetNaviKey = ToClient_WorldMapNaviStart( targetPos, NavigationGuideParam(), true, true )
	getSelfPlayer():setNavigationMovePath(targetNaviKey)
	getSelfPlayer():checkNaviPathUI(targetNaviKey)
end
