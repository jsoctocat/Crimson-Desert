...
ImGuiStyle::ImGuiStyle()
{
    ...
    WindowMinSize           = ImVec2(30,30);    // Minimum window size
    ...
    ItemSpacing             = ImVec2(5,5);      // Horizontal and vertical spacing between widgets/lines
    ...
    IndentSpacing           = 20.0f;            // Horizontal spacing when e.g. entering a tree node. Generally == (FontSize + FramePadding.x*2).
    ColumnsMinSpacing       = 5.0f;             // Minimum horizontal spacing between two columns
    ...
    DisplaySafeAreaPadding  = ImVec2(5,5);      // If you cannot see the edge of your screen (e.g. on a TV) increase the safe area padding. Covers popups/tooltips as well regular windows.
